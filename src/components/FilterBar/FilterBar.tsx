  ...
  return (
    <section className={style.FilterBarSection} id="Commande">
      ...
      <div className={style.FilterBarFlexDiet}>
        ...
        <button className={style.FilterBarButtonRefresh} onClick={handleRefreshClick}><svg width="30" height="30" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clip-path="url(#clip0_469_1541)">
